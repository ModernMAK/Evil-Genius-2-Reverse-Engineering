...
class ChunkParser:
    from packer.asura.models.chunks import HTextChunk, SoundChunk, RawChunk, ResourceChunk, ResourceListChunk, EofChunk
...
class ArchiveParser:
    from packer.asura.models.archive import FolderArchive, ZbbArchive
