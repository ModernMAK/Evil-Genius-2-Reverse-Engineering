...
from packer.asura.config import MEBI_BYTE, INT64_SIZE, INT32_SIZE, INT16_SIZE, WORD_SIZE
from packer.asura.enums.chunk_type import GenericChunkType
...
def split_asura_richtext(text: str) -> List[str]:
    """
    Splits an asura unicode 'richtext' string into it's raw and richtext parts.
