...
class ChunkParser:
    from asura.models.chunks import HTextChunk, SoundChunk, RawChunk, ResourceChunk, ResourceListChunk, EofChunk
...
class ChunkPacker:
    ...
    @classmethod
    def repack(cls, type: ChunkType, path: str) -> BaseChunk:
        repacker = cls._repack_map.get(type, cls._default_repack)
